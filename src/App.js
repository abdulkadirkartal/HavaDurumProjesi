  ...
  return (
    <div>
      <div className="navbar">
        <Navbar onSelectCity={handleCityClick} />
      </div>
      <div className="mainDiv">
        ...
        <form className="form" onSubmit={handleSubmit}>
          <input
            className="inputAlanı"
            type="text"
            value={sehir}
            onChange={sehirChange}
            placeholder="Şehir Adı Giriniz..."
          />
          <button className="buttonGonder" type="submit">
            Hava Durumu Al
          </button>
          <button className="buttonGonder" onClick={handleReset}>
            Sıfırla
          </button>
        </form>
        {havaData && (
          <div>
            ...
            <p className="lastDeger">
              Sıcaklık:{' '}
              {havaData.data.timelines[0].intervals[0].values.temperature} °C
            </p>
          </div>
        )}
      </div>
